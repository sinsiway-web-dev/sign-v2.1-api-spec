...
```
?startDate=1736920800&endDate=1737526473&docId=2025000013&docTitle=데이터 변경 요청서 1&requestName=홍길동&approverName=김관리&aprvLimitStart=1737526473&aprvLimitEnd=1737526473&dataModifyTargetName=PROD01&execStatus=0
```
## Response
|항목|값(예시)|타입|설명|
|---|---|---|---|
