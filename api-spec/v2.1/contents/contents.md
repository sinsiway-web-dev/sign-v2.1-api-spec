...
| execLogExist | true | boolean | 실행 로그 존재 여부 |
| doc | | Map | 결재 문서 정보 |
...
|passwordFlag|1|int|0: 비밀번호 실행 시 입력<br>1: 이미 입력됨|
...
```json
{
    ...
    "data": {
        ...
        "doc": {
            ...
            "docId": "2025000006",
            "groundsDocId": "",
            "createDate": "2025/07/21 16:46:22",
            "apvLimit": "2025/07/22",
            "requestOrgUid": "su1",
            "requestName": "관리자",
            "docTitle": "test",
        ...
        "dataModifyTarget": {
            ...
            "dataModifyTargetName": "testora1521",
            "dbTypeText": "ORACLE",
            "passwordFlag": 0,
